const userData = {
  ...
  experience: [
    {
      ...
      desc:
        "Assisted students with their assignments and projects. Helped them understand the concepts of Discrete Structures and graded homeworks.",
    },
    {
      title: "Researcher",
      company: "DAO Maker",
      ...
      desc:
        "Authored technical posts detailing various DeFi products like GMX, GHO, $DAO. Conducted market analysis of web3 events like Reddit NFTs Ethereum Merge, 3AC, and Taro",
    },
    {
      title: "Researcher",
      ...
      desc:
        "Authored a paper exploring fundamentals, tokenomics, and ecosystem of Avalanche network. Analysed Song A Day/DAO, a potential major Music NFT DAO in the future",
    },
    {
      ...
      desc:
        "Authored over 100 articles with a combined total of over 200k views and 5x Top writer on Medium in Programming, Business, Innovation, Crypto, and Technology. Published over 60 youtube videos and 200 educational posts on Instagram.",
    },
    {
      ...
      companyLink: "",
      desc:
        "We created a social stratup to help communities around our school. During COVID-19 we fed 1000+ people and released a song for social awareness.",
    },
    {
      title: "High School",
  ...
  resumeUrl:
    "https://docs.google.com/document/d/1RxgcNdTTYzMSTEvOTxmXCqJKGbCCB341iwQxeQ1rp_o/edit?usp=sharing",
  socialLinks: {
